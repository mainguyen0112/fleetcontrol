...
// +kubebuilder:rbac:groups=fleetcontrol.io,resources=satellites,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=fleetcontrol.io,resources=satellites/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=fleetcontrol.io,resources=satellites/finalizers,verbs=update
